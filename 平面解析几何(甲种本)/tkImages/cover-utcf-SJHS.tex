...
%    \def\theta{50}
%    \pgfmathsetmacro{\sintheta}{sin(\theta)} % sinθ 正弦
%    \pgfmathsetmacro{\costheta}{cos(\theta)} % cosθ 余弦
%    \pgfmathsetmacro{\tantheta}{tan(\theta)} % tanθ 正切
%    \pgfmathsetmacro{\sectheta}{1/cos(\theta)} % secθ=1/cosθ 正割
%    \pgfmathsetmacro{\csctheta}{1/sin(\theta)} % cscθ=1/sinθ
%    \pgfmathsetmacro{\cottheta}{1/tan(\theta)} % tanθ=1/tanθ
...
%     \def\theta{50} % 取消定义角度，直接输入，后续theta可显示符号θ
    ...
    \pgfmathsetmacro{\cottheta}{1/tan(50)} % tanθ=1/tanθ
