...
%\usepackage[T1]{fontspec}  % 通过 fontspec 宏包指定支持 Unicode 的字体
\usepackage{amsmath}
\usepackage{amsfonts}
\usepackage{amssymb}
\usepackage{stmaryrd}
...
%		\input{tkImages/fig1.1.tex}
	...
	\begin{subfigure}[h]{0.45\textwidth}
		\centering
%		\includegraphics[width=\textwidth]{images/01912c18-5c3f-733d-b775-749ba9897a9d_4_459236.jpg}
...
\customfootnote{
	❶\ding{172} lim 是拉丁文 limis (极限) 一词的前三个字母, 一般按英文 limit (极限) 一词读音。 \(\mathop{\lim }\limits_{{n \rightarrow \infty }}{a}_{n} = A\) 也可读作 “limit \({a}_{n}\) 当 \(n\) 趋于无穷大时等于 \({A}^{n}\) 。
}
...
\begin{figure}[h]
	\centering
	\includegraphics[max width=0.8\textwidth]{images/01912c18-5c3f-733d-b775-749ba9897a9d_7_608223.jpg}
	\caption{图 1-2}
\end{figure}
...
\begin{center}
	\adjustbox{max width=\textwidth}{
		\begin{tabular}{|c|c|c|c|c|c|c|}
			...
			\hline
			\(\left| {y - 4}\right|\) & 1.75 & 0.39 & 0.04 & 0.004 & 0.0004 & ...  \\
			\hline
		\end{tabular}
	}
\end{center}
...
\begin{problemset}[练习]
	...
	\begin{center}
		\adjustbox{max width=\textwidth}{
			\begin{tabular}{|c|c|c|c|c|c|c|}
				\hline
				\(x\) & 0 & \(\pm 2\) & \(\pm {10}\) & \(\pm {10}^{2}\) & \(\pm {10}^{3}\) & ...  \\
				\hline
...
%	\centering
%	% 3x3网格布局
%	\begin{tabular}{ccc} % 三列居中对齐
%		% 第一行
%		\input{tikz1.tex} & 
%		\input{tikz2.tex} & 
%		\input{tikz3.tex} \\[10pt] % 行间距
%		
%		% 第二行
%		\input{tikz4.tex} & 
%		\input{tikz5.tex} & 
%		\input{tikz6.tex} \\[10pt] % 行间距
%		
%		% 第三行
%		\input{tikz7.tex} & 
%		\input{tikz8.tex} & 
